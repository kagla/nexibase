...
export const pluginManifest: Record<string, PluginMeta> = {
  ...
  'shop': {
    ...
    myPageMenus: [{"label":"주문내역","icon":"ClipboardList","subPath":"/mypage/orders"},{"label":"찜 목록","icon":"Heart","subPath":"/mypage/wishlist"},{"label":"배송지","icon":"MapPin","subPath":"/mypage/addresses"}],
  }
}
